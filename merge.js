window.addEventListener('DOMContentLoaded', () => {
    ...
    async function merge(arr, low, mid, high) {
        ...
        for (let i = 0; i < n1; i++) {
            ...
            // color
            arr[low + i].style.background = 'lightcoral'; // Left part color
        ...
        for (let i = 0; i < n2; i++) {
            ...
            // color
            arr[mid + 1 + i].style.background = 'lightseagreen'; // Right part color
        ...
        while (i < n1 && j < n2) {
            ...
            if (parseInt(left[i]) <= parseInt(right[j])) {
                ...
                // color
                arr[k].style.background = 'lightgoldenrodyellow'; // Merged part color
        ...
        // To reset the color to lightgreen after merging is done
        for (let i = low; i <= high; i++) {
            await waitforme(delay);
            arr[i].style.background = 'lightgreen'; // Completed part color
        }
    }
